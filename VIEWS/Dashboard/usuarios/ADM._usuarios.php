                ...
                <div class="scroll-sidebar" data-simplebar>
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav" class="mb-0">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link has-arrow indigo-hover-bg active" href="javascript:void(0)" aria-expanded="false">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    <li class="sidebar-item">
                                        <a href="../../../VIEWS/Dashboard/usuarios/ADM._usuarios.php" class="sidebar-link active">
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body position-relative">
                                        <div>
                                            ...
                                            <p class="card-subtitle mb-3 pb-1"><u>AGREGAR | Usuario</u></p>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header d-flex align-items-center">
                                                        <h5 class="modal-title" id="addContactModalTitle">AGREGAR | Usuario</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="add-contact-box">
                                                            <div class="add-contact-content">
                                                                <form id="addContactModalTitle" action="../../../INCLUDES/Dashboard/usuarios/ADM._usuarios.php" method="POST">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3 contact-location">
                                                                                <input id="c_password" name="c_password" type="password" class="form-control" placeholder="Confirmar Contraseña" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="mb-3 contact-occupation">
                                                                                <select id="rol" name="rol" class="form-control">
                                                                                    <option disabled selected>Asignación</option>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <div class="d-flex gap-2 m-0">
                                                                            ...
                                                                            <button name="agregar_usuario" class="btn btn-success">AGREGAR</button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
                            ...
                            <div class="datatables">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mb-2">
                                            <h4 class="card-title mb-0">ADMINISTRACIÓN | Usuarios</h4>
                                        </div>
                                        <style>
                                            .text-justify {
                                                text-align: justify;
                                        ...
                                        <div class="table-responsive">
                                            <table id="file_export" class="table w-100 table-striped table-bordered display text-nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $sql_table = "SELECT * FROM usuarios";
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) { ?>
                                                            <tr>
                                                                ...
                                                                <td class="">
                                                                    <button class="btn bg-warning-subtle text-warning" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom<?php echo $row['id_usuario'] ?>" aria-controls="offcanvasBottom">
                                                                        Abrir
                                                                    </button>
                                                                </td>
                                                            ...
                                                            <!----- MODAL ----->
                                                            <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom<?php echo $row['id_usuario'] ?>" aria-labelledby="offcanvasBottomLabel">
                                                                <div class="offcanvas-header">
                                                                    <h4 class="offcanvas-title" id="offcanvasExampleLabel">
                                                                        <u>Información del Usuario</u>
                                                                    </h4>
                                                                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                                                </div>
                                                                <div class="offcanvas-body">
                                                                    <div>
                                                                        <!-- <b>IDㅤ|ㅤ</b><?php echo $row['id_usuario'] ?> <br> -->
                                                                        <b>NOMBREㅤ|ㅤ</b><?php echo $row['nombre'] ?> <br>
                                                                        <b>APELLIDOㅤ|ㅤ</b><?php echo $row['apellido'] ?> <br>
                                                                        <b>USUARIOㅤ|ㅤ</b><?php echo $row['usuario'] ?> <br>
                                                                        <b>CORREO ELECTRÓNICOㅤ|ㅤ</b><?php echo $row['correo_electronico'] ?> <br>
                                                                        <b>ASIGNACIÓNㅤ|ㅤ</b><?php if ($row['rol'] == 1) {
                                                                                                echo ('Super Administrador');
                                                                                            } elseif ($row['rol'] == 2) {
                                                                                                echo ('Administrador');
                                                                                            } ?> <br>
                                                                        <b>ESTADOㅤ|ㅤ</b><?php echo $row['estado'] ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!----- ----- ----->
