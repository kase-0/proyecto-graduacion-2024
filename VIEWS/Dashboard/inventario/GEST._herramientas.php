...
?>
    ...
    <head>
        ...
        <title>CSSC | GEST. HERRAMIENTAS</title>
                ...
                <div class="scroll-sidebar" data-simplebar>
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav" class="mb-0">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link has-arrow warning-hover-bg active" href="javascript:void(0)" aria-expanded="false">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="../../../VIEWS/Dashboard/inventario/GEST._herramientas.php" class="sidebar-link active">
                                            <span class="sidebar-icon"></span>
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body position-relative">
                                        <div>
                                            ...
                                            <p class="card-subtitle mb-3 pb-1"><u>AGREGAR | Herramienta</u></p>
                                            <button id="btn-add-contact" class="btn btn-primary rounded-pill" type="button" data-bs-toggle="modal" data-bs-target="#addContactModal">
                                                AGREGAR
                                            </button>
                                        </div>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header d-flex align-items-center">
                                                        <h5 class="modal-title" id="addContactModalTitle">AGREGAR | Herramienta</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="add-contact-box">
                                                            <div class="add-contact-content">
                                                                <form id="addContactModalTitle" action="../../../INCLUDES/Dashboard/inventario/GEST._herramientas.php" method="POST">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="mb-3 contact-occupation">
                                                                                <input type="text" id="nombre_herramienta" name="nombre_herramienta" class="form-control" placeholder="Nombre" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3 contact-occupation">
                                                                                <select name="categoria_herramienta" class="form-control">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3 contact-occupation">
                                                                                <div class="mb-3 contact-location">
                                                                                    <input id="codigo_herramienta" name="codigo_herramienta" class="form-control" placeholder="Código" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3 contact-phone">
                                                                                <input type="text" id="stocktotal_herramienta" name="stocktotal_herramienta" class="form-control" placeholder="Stock" />
                                                                                <span class="validation-text text-danger"></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3 contact-location">
                                                                                <input id="precio_herramienta" name="precio_herramienta" class="form-control" placeholder="Precio" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="mb-3 contact-occupation">
                                                                                <div class="mb-3 contact-location">
                                                                                    <input id="descripcion_herramienta" name="descripcion_herramienta" class="form-control" placeholder="Descripción" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <div class="d-flex gap-2 m-0">
                                                                            <button class="btn bg-danger-subtle text-danger" data-bs-dismiss="modal">CERRAR</button>
                                                                            <button type="submit" name="agregar_herramienta" class="btn btn-success">AGREGAR</button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
                                        ...
                                        <div class="school-img d-none d-sm-block img-position">
                                            <img src="https://bootstrapdemos.wrappixel.com/spike/dist/assets/images/backgrounds/track-bg.png" class="img-fluid" alt="spike-img" />
                                        </div>
                            ...
                            <div class="datatables">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mb-2">
                                            <h4 class="card-title mb-0">GESTIÓN | Herramientas</h4>
                                        </div>
                                        <style>
                                            .text-justify {
                                                text-align: justify;
                                        ...
                                        <p class="card-subtitle mb-3 text-justify">
                                            El formulario de gestión de herramientas de trabajo es una herramienta
                                            clave para la eficiencia operativa. Facilita la organización y el seguimiento de las herramientas,
                                            permitiendo una gestión efectiva y un mantenimiento proactivo.
                                            Es un componente esencial para cualquier equipo que busca optimizar su proceso
                                            de trabajo y asegurar la disponibilidad y funcionalidad de sus herramientas.
                                        </p>
                                        <br>
                                        <style>
                                            td {
                                        ...
                                        <div class="table-responsive">
                                            <table id="file_export" class="table w-100 table-striped table-bordered display text-nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $sql_table = "SELECT * FROM herramientas";
                                                    $result = $conexion->query($sql_table);
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) { ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $row['categoria_herramienta'] ?></td>
                                                                <td><?php echo $row['precio_herramienta'] ?></td>
                                                                <td><?php echo $row['stocktotal_herramienta'] ?></td>
                                                                <td><?php echo $row['stockdisponible_herramienta'] ?></td>
                                                                <td class="">
                                                                    <button class="btn bg-warning-subtle text-warning" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom<?php echo $row['id_herramienta'] ?>" aria-controls="offcanvasBottom">
                                                                        Abrir
                                                                    </button>
                                                                </td>
                                                                <!-- <td>
                                                            ...
                                                            <!----- MODAL ----->
                                                            <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom<?php echo $row['id_herramienta'] ?>" aria-labelledby="offcanvasBottomLabel">
                                                                ...
                                                                <div class="offcanvas-body">
                                                                    <div>
                                                                        <?php echo $row['descripcion_herramienta'] ?>
